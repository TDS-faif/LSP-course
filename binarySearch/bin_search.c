...
int main(int argc, char **argv)
{
	...
	wd_t wd;
	int ans;
	char word[183]; //Store the word here. A fixed size array to store the word is simpler and faster than reallocating every time. The longest word to ever appear in literature in english is 183 letters long.
